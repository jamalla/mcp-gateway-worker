...
**Tests**: Contract tests are REQUIRED for every public endpoint. Unit/integration tests are
required where needed to prove behavior and module boundaries.
...
### Tests for User Story 1 (REQUIRED for public behavior) ⚠️
...
- [ ] T018 [US1] Add request_id propagation and structured logs for gateway↔worker calls
- [ ] T019 [US1] Document endpoint example request/response contract in specs/[###-feature-name]/quickstart.md
...
### Tests for User Story 2 (REQUIRED for public behavior) ⚠️
...
### Tests for User Story 3 (REQUIRED for public behavior) ⚠️
...
- Contract tests for each public endpoint MUST be written and FAIL before implementation
